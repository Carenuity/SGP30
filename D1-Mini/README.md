...
## Introduction
The Air-Quality-Meter is a plug-and-play device designed to monitor indoor air quality. It uses the SGP30 sensor from Sensirion to detect volatile organic compounds (VOCs) and carbon dioxide (CO2) levels, along with humidity data. The device is built around the **D1 Mini** microcontroller and features an OLED display for real-time readings. This project is brought to you by Carenuity, offering a free IoT application that simplifies air quality monitoring.

## Components Required
- SGP30 Gas Sensor Module by Sensirion - ChipGlobe Shop
- D1 Mini Microcontroller - ChipGlobe Shop
- OLED Display (compatible with D1 Mini) - ChipGlobe Shop
- Triple Adapter for plug-and-play connectivity - ChipGlobe Shop
- A USB data cable
- Access to a computer

You can purchase these components from our shop: ChipGlobe Shop

## Installation
### Plug the Components:
Plug the SGP30 sensor, D1 Mini microcontroller, and the OLED display to the triple adapter as shown.

*image*

### Install Firmware:
- Use a suitable data cable, and connect the device to your computer.
- Visit solutions.carenuity.com and look for the Air Quality application template.
- Click on the "Install" button for the Air-Quality-Meter application.
- Follow the on-screen instructions to install the pre-built firmware onto the D1 Mini microcontroller.
...
- **Website:** solutions.carenuity.com
